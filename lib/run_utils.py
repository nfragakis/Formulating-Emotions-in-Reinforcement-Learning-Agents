from lib.user_config import DEFAULT_DATA_DIR, FORCE_DATESTAMP, \
                               DEFAULT_SHORTHAND, WAIT_BEFORE_LAUNCH
from lib.logx import colorize
from lib.mpi_tools import mpi_fork, msg
from lib.serialization_utils import convert_json
import base64
